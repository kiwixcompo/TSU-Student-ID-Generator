    ...
    <div class="dashboard-header">
        <div class="header-content">
            ...
            <div class="header-right">
                ...
                <?php endif; ?>
                <a href="photo-manager.php" class="btn btn-sm" style="background:#d97706;color:white;border:none;">
                    <svg style="width:15px;height:15px;stroke:currentColor;stroke-width:2;" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <tr data-student-id="<?php echo e($student['id']); ?>">
                            ...
                            <td>
                                <div class="action-buttons">
                                    ...
                                    <a href="id-card.php?id=<?php echo e($student['id']); ?>" class="btn-generate" target="_blank">Generate ID</a>
                                </div>
                            </td>
                        </tr>
                        <?php endforeach; ?>
