...
function getTsuData() {
    return [
        [
            ...
            'departments' => [
                ['name' => 'Agric Extension & Economics', 'programmes' => ['B. Agric - Agric Economics', 'B. Agric - Agric Extension']],
                ['name' => 'Agronomy', 'programmes' => ['B. Agric- Agronomy']],
                ['name' => 'Animal Science', 'programmes' => ['B. Agric- Animal Science']],
        ...
        [
            ...
            'departments' => [
                ['name' => 'English & Literary Studies', 'programmes' => ['B. A. English']],
                ['name' => 'Theatre & Film Studies', 'programmes' => ['B. A. Theatre & Film Studies']],
        ...
        [
            ...
            'departments' => [
                ['name' => 'Arts Education', 'programmes' => ['B. A. (Ed) English', 'B. A. (Ed) CRS', 'B. A. (Ed) Hausa', 'B. A. (Ed) History', 'B. A. (Ed) ISL']],
                ['name' => 'Educational Foundations', 'programmes' => ['B. Ed Education Admin & Planning']],
                ['name' => 'Counselling, Educational Psychology and Human Development', 'programmes' => ['B. Ed Guidance & Counselling', 'B. Ed Primary Education']],
                ['name' => 'Science Education', 'programmes' => ['B. Sc. (Ed) Biology', 'B. Sc. (Ed) Chemistry', 'B. Sc. (Ed) Integrated Science', 'B. Sc. (Ed) Mathematics', 'B. Sc. (Ed) Physics']],
        ...
        [
            ...
            'departments' => [
                ['name' => 'Economics', 'programmes' => ['B. Sc. Economics']],
